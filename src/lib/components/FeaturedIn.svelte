<script>
    ...
    const logos = [
        ...
        },
        {
            ...
            alt: 'Nieuwe Oogst',
            href: 'https://www.nieuweoogst.nl/nieuws/2025/09/30/melkveehouder-ontwikkelt-cowcatcher-gratis-programma-voor-tochtdetectie'
        },
        {
            ...
            href: 'https://www.mechaman.nl/veehouderij-techniek/artikel/20260720/koe-volgen-met-camera-zo-werkt-cowcatcher/'
        },
        {
            src: sterkeErvenLogo,
    ...
    // De lijst wordt verdubbeld zodat de animatie naadloos kan doorlopen.
...
<section class="featured-in-section">
    ...
    <div class="carousel-container">
        <!-- Breedte en verschuiving worden afgeleid van het aantal logo's,
             zodat de animatie klopt als er een logo bijkomt of afgaat. -->
        <div class="carousel-track" style="--logo-count: {logos.length}">
            {#each carouselLogos as logo}
                <div class="logo-item">
                    <a href={logo.href} target="_blank" rel="noopener noreferrer">
                        <img src={logo.src} alt={logo.alt} class:white-logo-fix={logo.isWhiteLogo} />
                    </a>
                </div>
            {/each}
        </div>
